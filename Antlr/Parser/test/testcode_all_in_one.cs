// Note: this piece of code is just for testing and debugging the parser. The code itself can't compile and is not meant for compiling.
...
namespace A.B.C.D {
    ...
    /*
        Area Comment
    */
    public sealed class ClassA : BaseA, InterfaceA {
        /*
         Area Comment
         int a = 1;
         int b = 2;
        ...
        */
        ...
        private int a;
        public A b;
        private float c = 3.1415926535f;
        public double value;
        public int[] array;
        public int[,] matrix_1;
        public int[][] matrix_2;
        private SomeClass someObject;
        private Dictionary<string, List<SomeClass>> someDictionary;

        // 'get' and 'set' are also valid identifier names!
        private int get;
        private int set;
        ...
        private override int fun2(double param1) {
            int a = 0;
        }

        private virtual int fun3<T, U, V>(int param1, ref ClassA param2, out double param3) {
            string a = "Hello World";
        }

        int InterfaceA.fun4(int a, int b) {
            float a = 3.14f;
        }

        // Import external method
        [DllImport("ExternalModule.dll")]
        public static extern int externalMethod(int param1, int param2);
    }
    public abstract class ClassB<T, U, V> where T : System.Generic.Collections.List<T>, new() where U : BaseU<U>{}
    class ClassC{}
    public interface InterfaceA{
        int fun4(int a);
    }
    interface InterfaceC<T> where T: ClassB<T, Int32, Int64>{}
